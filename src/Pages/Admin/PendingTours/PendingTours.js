...
const PendingTours = () => {
  ...
  useEffect(() => {
    fetch("https://myapp-8k92brsir-ashik763.vercel.app/allPendingTours")
      .then((res) => res.json())
      .then((data) => {
            ...
            <div className="card  bg-base-100 shadow-xl">
              <PhotoProvider>
                <figure className="border w-full p-3">
                  <PhotoView src={pendingTour.img2}>
                    <img
                      className="w-full h-[16rem] object-cover "
                      src={pendingTour.img2}
                      alt="img"
                    />
                  </PhotoView>
                </figure>
              ...
              <div className="card-body h-[10rem]">
                <p className="font-bold">{pendingTour.tour_name}</p>

...
const ApprovedTours = () => {
  ...
  //     fetch(`https://myapp-8k92brsir-ashik763.vercel.app/approveTour/${pendingTour._id}`, {
  //       method: "PATCH",
  //       headers: {
            ...
            <div className="card  bg-base-100 shadow-xl">
              ...
              <div className="card-body h-[10rem]">
                ...
                <div className="card-actions   ">
                  <div className="text-xs font-thin flex flex-row justify-around mt-1 w-full ">
                    {/* <div> 
                                            <button onClick={()=> handleApprove(pendingTour)  } className="btn btn-outline btn-success">Approve</button>
                                        </div> */}
                    <div>
                      <button
                        onClick={() => handleDecline(pendingTour)}
